...
/**
 * This is a pluggable, toggled command that extends <i>PluginCommand</i>
 * 
 */
public abstract class PluginToggledCommand extends PluginCommand {

    /* (non-Javadoc)
     * @see com.cysols.framework.platform.PluginCommand#entryPoint(java.awt.event.ActionEvent)
     */
    ...
    */     
    public PluginToggledCommand(String name) {
        super(name);
    }
